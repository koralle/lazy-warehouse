...
var UserTableColumns = struct {
	...
	CreatedAt:       "users._created_at",
	UpdatedAt:       "users._updated_at",
}
...
var UserWhere = struct {
	...
	ID:              whereHelperstring{field: "\"lazy_warehouse\".\"users\".\"id\""},
	Name:            whereHelperstring{field: "\"lazy_warehouse\".\"users\".\"name\""},
	Email:           whereHelperstring{field: "\"lazy_warehouse\".\"users\".\"email\""},
	ProfileImageURL: whereHelpernull_String{field: "\"lazy_warehouse\".\"users\".\"profile_image_url\""},
	CreatedAt:       whereHelpertime_Time{field: "\"lazy_warehouse\".\"users\".\"_created_at\""},
	UpdatedAt:       whereHelpertime_Time{field: "\"lazy_warehouse\".\"users\".\"_updated_at\""},
}
...
var (
	userAllColumns            = []string{"id", "name", "email", "profile_image_url", "_created_at", "_updated_at"}
	userColumnsWithoutDefault = []string{"id", "name", "email"}
	userColumnsWithDefault    = []string{"profile_image_url", "_created_at", "_updated_at"}
...
func Users(mods ...qm.QueryMod) userQuery {
	mods = append(mods, qm.From("\"lazy_warehouse\".\"users\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"lazy_warehouse\".\"users\".*"})
	}
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*User, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"lazy_warehouse\".\"users\" where \"id\"=$1", sel,
	)
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"lazy_warehouse\".\"users\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"lazy_warehouse\".\"users\" %sDEFAULT VALUES%s"
		}
...
func (o *User) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"lazy_warehouse\".\"users\" SET %s WHERE %s",
...
func (o UserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"lazy_warehouse\".\"users\" SET %s WHERE %s",
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"lazy_warehouse\".\"users\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"lazy_warehouse\".\"users\" WHERE \"id\"=$1"
...
func (o UserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"lazy_warehouse\".\"users\" WHERE " +
...
func (o *UserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"lazy_warehouse\".\"users\".* FROM \"lazy_warehouse\".\"users\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, userPrimaryKeyColumns, len(*o))
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"lazy_warehouse\".\"users\" where \"id\"=$1 limit 1)"
